                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" type="text" 
                                           ...
                                           <label>UF</label>  
                                    <input class="form-control" type="text" 
                                           value="<?php echo $fo->getUf(); ?>" name="uf">
                                    ...
                                    <input class="form-control" type="text" 
                                           ...
                                           <label>Email</label>  
                                    <input class="form-control" type="text" 
                                           value="<?php echo $fo->getCidade(); ?>" name="email">

                                           <label>Telefone Fixo</label>  
                                    <input class="form-control" type="text" 
                                           value="<?php echo $fo->getCidade(); ?>" name="telfixo">

                                           <label>Telefone Celular</label>  
                                    <input class="form-control" type="text" 
                                           value="<?php echo $fo->getCidade(); ?>" name="telcel">
                                ...
                                if ($listaFornecedores != null) {
                                    foreach ($listaFornecedores as $lf) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="cadastroFornecedor.php?id=<?php echo $lp->getIdFornecedor(); ?>"
                                                   class="btn btn-light">
